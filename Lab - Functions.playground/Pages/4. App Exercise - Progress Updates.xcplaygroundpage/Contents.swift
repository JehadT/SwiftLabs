...
func progressUpdate(steps:Int,goal:Int) {
    ...
    } else if steps < (goal/2) && steps >= (goal/100*10) {
        print("You're almost halfway there!")
    } else if steps < (goal/100*90) && steps >= (goal/2) {
        print("You're over halfway there!")
    } else if steps < goal && steps >= (goal/100*90) {
...
pacing(currentDistance: 4000, totalDistance: 10000, currentTime: 160, goalTime: 300)
pacing(currentDistance: 6000, totalDistance: 10000, currentTime: 160, goalTime: 300)
